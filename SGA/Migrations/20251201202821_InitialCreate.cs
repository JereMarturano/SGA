        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaCumpleanios = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RequiereFactura = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockMinimoAlerta = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    UnidadDeMedida = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    EsHuevo = table.Column<bool>(type: "bit", nullable: false),
                    Tamano = table.Column<int>(type: "int", nullable: true),
                    Color = table.Column<int>(type: "int", nullable: true),
                    UnidadesPorBulto = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HistorialAccionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsumoPromedioLts100Km = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CapacidadCarga = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ID_Chofer_Asignado = table.Column<int>(type: "int", nullable: true),
                    EnRuta = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LitrosCombustible = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    UsuarioId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
