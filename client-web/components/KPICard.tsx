...
export default function KPICard({
  ...
  const Content = (
    ...
    >
      ...
      <div
        className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${colorStyles[color]} opacity-5 rounded-bl-full -mr-4 -mt-4 transition-transform group-hover:scale-110`}
      />
