                ...
                <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-xl border border-slate-100 dark:border-slate-700">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 dark:text-slate-400">Registrar compra de mercadería (Huevos) para el depósito central.</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-6 border border-slate-200 dark:border-slate-700">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <div className="p-4 bg-white dark:bg-slate-800 rounded-xl shadow-sm">
                                    <p className="text-xs text-slate-500 dark:text-slate-400 uppercase font-bold">Total Unidades</p>
                                ...
                                <div className="p-4 bg-white dark:bg-slate-800 rounded-xl shadow-sm">
                                    <p className="text-xs text-slate-500 dark:text-slate-400 uppercase font-bold">Costo Unitario</p>
                                ...
                                <div className="p-4 bg-white dark:bg-slate-800 rounded-xl shadow-sm">
                                    <p className="text-xs text-slate-500 dark:text-slate-400 uppercase font-bold">Total a Pagar</p>
                        ...
                        <button
                            type="submit"
                            disabled={submitting || !formData.productoId || !formData.cantidad || !formData.precio}
