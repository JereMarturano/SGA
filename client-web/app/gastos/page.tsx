...
export default function GastosPage() {
  ...
  const selectedTypeInfo =
    selectedType !== null ? TIPOS_GASTO.find((t) => t.id === selectedType) : null;
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300 pb-20">
      ...
      <main className="max-w-md mx-auto px-4 py-6">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-black text-slate-800 dark:text-white">Hola, Santiago 👋</h1>
          <p className="text-slate-500 dark:text-slate-400">¿Qué gastos tuvimos hoy?</p>
        </div>
        ...
        {!selectedTypeInfo ? (
          <div className="grid grid-cols-3 gap-4 mb-10">
            {TIPOS_GASTO.map((tipo) => (
              ...
              >
                <div
                  className={`p-3 rounded-xl ${tipo.color} text-white mb-2 shadow-lg shadow-${tipo.color}/30`}
                >
                  <tipo.icon size={24} />
                </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                disabled={
                  isSubmitting ||
                  !amount ||
                  ([0, 1, 2, 3, 4].includes(selectedType || -1) && !selectedVehiculoId)
                }
